        ...
        <div class="movie-card border-radius-1">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-15 col-20 text-white">
                    ...
                    <br>
                    @if($movie->director != "")
                    <b class="text-white">{{ $text_setting[6] != "" ? $text_setting[6] : "Director" }}:</b> {{ $movie->director }}
                    @endif
                    @if($movie->action != "")
                    <br>
                    <b class="text-white">{{ $text_setting[7] != "" ? $text_setting[7] : "Actors" }}:</b> {{ $movie->actors != "" ? $movie->actors : "-" }}
                    @endif
                    <br>
                    <b class="text-white">{{ $text_setting[8] != "" ? $text_setting[8] : "Genre" }}:</b> 
                    @if(isset($genre))
                    ...
                    @endif
                    <hr>
                    <p class="text-white badge badge-secondary">{{ $text_setting[9] != "" ? $text_setting[9] : "เรื่องย่อ" }}</p>
            ...
            <div class="card-body">
                {{-- <ul class="list-group list-group-flush sound-movie" id="sound_th"> --}}
                    @if($movie->file_main_sub_3 != "")
                        ...
                        @endphp
                        <li class="list-group-item resolutionep" data-href="{{ $movie->file_main_sub_3 }}">360p</li>
                    @endif
                    @if($movie->file_main_sub_2 != "")
                        ...
                        @endphp
                        <li class="list-group-item resolutionep" data-href="{{ $movie->file_main_sub_3 }}">720p</li>
                    @endif
                    @if($movie->file_main_sub != "")
                        ...
                        @endphp
                        <button data-href="{{ $movie->file_main_sub }}" type="button" class="resolutionep btn btn-warning">
                            <i class="glyphicon glyphicon-hd-video"></i>
                            1080p
                        </button>
                        {{-- <li class="list-group-item resolutionep" data-href="{{ $movie->file_main_sub }}">1080p</li> --}}
                    @endif
                {{-- </ul> --}}
...
<script>
    $(document).ready(function () {
        ...
        $('#description').readmore({
            ...
            collapsedHeight: 20,
            heightMargin: 16,
            moreLink: '<a href="#" class="badge badge-light" >{{ $text_setting[10] != "" ? $text_setting[10] : "แสดงเพิ่ม" }}</a>',
