    ...
    <div class="col-lg-12">
        ...
        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <form method="post" action="{{ route('admin.seo.store') }}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <textarea type="text" id="onpage_header" name="onpage_header" rows="20" class="form-control form-control-line">{{ option_get('onpage_header') }}</textarea>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-12 col-form-label">Onpage Footer ใส่ข้อความด้านล่างหน้าแรก</label>
                                                        <div class="col-sm-12">
                                                            <textarea type="text" id="onpage_footer" name="onpage_footer" rows="20" class="form-control form-control-line">{{ option_get('onpage_footer') }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 mt-4">
                                                            <button type="submit" class="btn btn-success btn-lg" id="save-data">อัพเดท</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <script>
                                                ...
                                                //     let onpage_header = $("#onpage_header").html();
                                                //     let _token   = $('meta[name="csrf-token"]').attr('content');
                                                //     let user_token   = $('meta[name="remember-token"]').attr('content');
                    ...
                    <script>
                        ...
                        var textarea = document.getElementById('onpage_header');
                        sceditor.create(textarea, {
                            style: '{{ asset("minified/themes/content/default.min.css") }}'
                        });

                        var textarea_footer = document.getElementById('onpage_footer');
                        sceditor.create(textarea_footer, {
                            style: '{{ asset("minified/themes/content/default.min.css") }}'
                        });
                    </script>
@endsection
