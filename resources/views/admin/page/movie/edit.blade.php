                                ...
                                <form class="form-horizontal form-material" enctype="multipart/form-data" action="{{ route('admin.movie.update', ['id'=> $movie->id]) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-1 col-sm-6">
                                                <label>ปักหมุด</label>
                                                <select class="form-control form-control-line" name="movie_hot">
                                                    <option value="0" {{ $movie->movie_hot == "1" ? 'selected' : '' }}>ปิด</option>
                                                    <option value="1" {{ $movie->movie_hot == "1" ? 'selected' : '' }}>เปิด</option>
                                                </select>
                                            </div>
                                            @endif
                                            @if($setting->imdb == 1)
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea rows="15" name="description" id="description" class="form-control form-control-line">{{ $movie->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
