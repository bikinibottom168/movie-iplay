...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar" style="overflow-y: auto;height: 100%">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample" >
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="themes" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{ route('admin.themesetting') }}?type=word_status"> Word Letter A-Z </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.themesetting') }}?type=text_setting"> Text Setting </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="{{ route('admin.themeeditor',['type' => "home"]) }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pen-tool"><path d="M12 19l7-7 3 3-7 7-3-3z"></path><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"></path><path d="M2 2l7.586 7.586"></path><circle cx="11" cy="11" r="2"></circle></svg>                        <span>Theme Editor</span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu">
                <a href="{{ route('admin.moviecontact') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">

                            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                            <path d="M942 5105 c-23 -7 -66 -31 -95 -53 -29 -23 -219 -209 -423 -414 -273 -275 -376 -385 -393 -420 -31 -66 -37 -141 -16 -214 l17 -59 691 -693 692 -692 -692 -693 -691 -692 -17 -59 c-21 -71 -16 -148 14 -209 14 -28 156 -177 438 -459 400 -398 420 -417 472 -432 69 -20 113 -20 182 0 52 15 76 37 747 707 l692 692 693 -692 c670 -670 694 -692 746 -707 69 -20 113 -20 182 0 52 15 72 34 472 432 282 282 424 431 438 459 30 61 35 138 14 209 l-17 59 -691 692 -692 693 692 692 691 693 17 59 c21 73 15 148 -16 214 -32 68 -803 839 -871 871 -66 31 -141 37 -214 16 l-59 -17 -692 -691 -693 -692 -692 692 c-671 670 -695 692 -747 707 -65 19 -121 19 -179 1z"/>
                            </g>
                            </svg>
