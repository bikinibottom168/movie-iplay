...
Route::get('/update/key', function() {
    $data = Artisan::call('key:generate');
});
...
//  Streaming
Route::get('/streaming-test/streaming', 'MovieController@streaming_test')->name('streaming.test');
...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        //     Seo Resource
        // -----------------------------
        Route::resource('themeeditor', 'AdminThemeEditorController', ['names' => [
            'index' => 'admin.themeeditor',
            'create' => 'admin.themeeditor.create',
            'store' => 'admin.themeeditor.store',
            'show' => 'admin.themeeditor.show',
            'edit' => 'admin.themeeditor.edit',
            'update' => 'admin.themeeditor.update',
            'destroy' => 'admin.themeeditor.destroy'
        ]]);

        Route::get('code-editor/{file}', 'AdminThemeEditorController@code_editor')->name('code.editor');

        Route::post('code-editor/{file}', 'AdminThemeEditorController@code_editor_post')->name('code.editor.post');
